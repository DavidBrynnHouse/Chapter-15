...
public class WorkingClockDBH extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        EventHandler<ActionEvent> eventHandler = e -> clock1.setCurrentTime();
        ...
        start.setOnAction(event -> {
            start.setOnMouseClicked(e1 -> animation.play());
        });

        stop.setOnAction(event -> {
            stop.setOnMouseClicked(e1 -> animation.pause());
        });
